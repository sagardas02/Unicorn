(function ($) {
    ...
    $(document).ready(function() {
        if ($(".service-slider").length) {
            const owl = $(".service-slider").owlCarousel({
                autoplay: true,
                smartSpeed: 300,
                loop: true,
                autoplayHoverPause: true,
                ...
                navContainer: ".owl-nav", // Custom navigation container
                items: 4,
                responsive: {
                    0: {
                        items: 1,
            ...
            $(".owl-prev").click(function() {
                owl.trigger("prev.owl.carousel"); // Go to the previous item
            });
    
            $(".owl-next").click(function() {
                owl.trigger("next.owl.carousel"); // Go to the next item
            });
        }
    });
